...
export const TaskInfo = () => {
    ...
    const [taskInfo, setTaskInfo] = useState<TaskInfoModel>(new TaskInfoModel())
...
const TaskInfoContent = (props: { taskInfo: TaskInfoModel }) => {
...
const TaskLogList = (props:{taskId:number}) => {
    const {taskId} = props
